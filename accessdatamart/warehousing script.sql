...
-- set search path for access_processor
ALTER ROLE access_processor IN DATABASE openclinica
  SET search_path = dm;
-- grant privileges to the dm schema for access_processor
GRANT ALL PRIVILEGES ON SCHEMA dm TO access_processor;
GRANT SELECT ON ALL TABLES IN SCHEMA dm to access_processor;
GRANT CREATE ON DATABASE openclinica TO access_processor;