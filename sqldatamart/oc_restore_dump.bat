...
REM Run warehousing scripts
C:\"Program Files"\PostgreSQL\9.2\bin\psql --dbname=openclinica -U clinica --file="C:\Users\Lstevens\Desktop\oc_gather_data.sql"
C:\"Program Files"\PostgreSQL\9.2\bin\psql --dbname=openclinica -U clinica --file="C:\Users\Lstevens\Desktop\oc_transform_datasets.sql"