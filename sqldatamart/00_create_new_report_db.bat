...
set FDWSERVERHOST=the live server IP
...
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d postgres -c "CREATE DATABASE %NEWDBNAME%;" -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT01% -v FDWSERVERNAME=%FDWSERVERNAME% -v FDWSERVERHOST=^'%FDWSERVERHOST%^' -v FDWSERVERPORT=^'%FDWSERVERPORT%^' -v FDWSERVERDBNAME=^'%FDWSERVERDBNAME%^' -v FDWSERVERUSER=^'%FDWSERVERUSER%^' -v FDWSERVERPASS=^'%FDWSERVERPASS%^' -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT02% -v FDWSERVERNAME=%FDWSERVERNAME% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT03% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT04% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT05% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT06% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT07% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT08% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT09% -P pager
C:\"Program Files"\PostgreSQL\9.3\bin\psql -q -d %NEWDBNAME% -f %SCRIPT10% -P pager
