...
<xsl:value-of select="concat($vFormName,'_',$vItemGroupName)"/> &lt;- data.frame(SubjectID=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../../@OpenClinica:StudySubjectID"/>'</xsl:for-each>),
  ProtocolID=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
  ...
  Sex=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../../@OpenClinica:Sex"/>'</xsl:for-each>)</xsl:if><xsl:if test="$dobExist">,
  DateOfBirth=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../../@OpenClinica:DateOfBirth"/>'</xsl:for-each>)</xsl:if><xsl:if test="$yobExist">,
  YearOfBirth=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../../@OpenClinica:YearOfBirth"/>'</xsl:for-each>)</xsl:if><xsl:if test="$uniqueIdExist">,
  PersonID=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../../@OpenClinica:UniqueIdentifier"/>'</xsl:for-each>)</xsl:if><xsl:if test="$secondaryIdExist">,
  SecondaryID=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../../@OpenClinica:SecondaryID"/>'</xsl:for-each>)</xsl:if><xsl:if test="$subjectStatusExist">,
  Status=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../../@OpenClinica:Status"/>'</xsl:for-each>)</xsl:if>,
  EventName=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:variable name="vStudyEventOID">
            <xsl:value-of select="../../@StudyEventOID"/>
        </xsl:variable>
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="/odm:ODM/odm:Study/odm:MetaDataVersion/odm:StudyEventDef[@OID=$vStudyEventOID]/@Name"/>'</xsl:for-each>),
  EventStatus=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../@OpenClinica:Status"/>'</xsl:for-each>),
  EventStartDate=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../@OpenClinica:StartDate"/>'</xsl:for-each>),
  EventEndDate=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../@OpenClinica:EndDate"/>'</xsl:for-each>),
  EventLocation=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../../@OpenClinica:StudyEventLocation"/>'</xsl:for-each>),
  SubjectAgeAtEvent=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:variable name="vSubjectAgeAtEvent">
            <xsl:value-of select="../../@OpenClinica:SubjectAgeAtEvent"/>
        </xsl:variable>
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="$vSubjectAgeAtEvent"/>'</xsl:for-each>),
  ...
  CRFName=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:variable name="vFormOID">
            ...
            <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="/odm:ODM/odm:Study/odm:MetaDataVersion/odm:FormDef[@OID=$vFormOID]/@Name"/>'</xsl:for-each>),
  CRFStatus=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="../@OpenClinica:Status"/>'</xsl:for-each>),
  CRFInterviewDate=c(
    <xsl:for-each select="/odm:ODM/odm:ClinicalData/odm:SubjectData/odm:StudyEventData/odm:FormData/odm:ItemGroupData[@ItemGroupOID=$ItemGroupOID]">
        ...
        <xsl:if test="position()>1">,</xsl:if>'<xsl:value-of select="$vStartDate"/>'</xsl:for-each>),
